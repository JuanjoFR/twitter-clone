...
Default.args = {
  ...
  onAttachImageClick:
    createActionHandler<HTMLAnchorElement>("onAttachImageClick"),
  onAttachGifClick: createActionHandler<HTMLAnchorElement>("onAttachGifClick"),
  onCreatePollClick:
    createActionHandler<HTMLAnchorElement>("onCreatePollClick"),
  onAttachEmojiClick:
    createActionHandler<HTMLAnchorElement>("onAttachEmojiClick"),
  onScheduleClick: createActionHandler<HTMLAnchorElement>("onScheduleClick"),
  onAttachLocationClick: createActionHandler<HTMLAnchorElement>(
    "onAttachLocationClick"
  ),

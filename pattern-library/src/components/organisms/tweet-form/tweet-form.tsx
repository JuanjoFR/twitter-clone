      ...
      <div className="min-h-5 flex-1">
        ...
        <div className="flex items-center justify-between">
          <div className="flex h-10 gap-4 items-center">
            ...
            <button onClick={onAttachGifClick}>
              <svg
                viewBox="0 0 24 24"
                aria-hidden="true"
                className="h-5 w-5 fill-[#1d9bf0]"
            ...
            <button className="hidden md:flex" onClick={onCreatePollClick}>
              <svg
                viewBox="0 0 24 24"
                aria-hidden="true"
                className="h-5 w-5 fill-[#1d9bf0]"
            ...
            <button onClick={onAttachEmojiClick}>
              <svg
                viewBox="0 0 24 24"
                aria-hidden="true"
                className="h-5 w-5 fill-[#1d9bf0]"
            ...
            <button className="hidden md:flex" onClick={onScheduleClick}>
              <svg
                viewBox="0 0 24 24"
                aria-hidden="true"
                className="h-5 w-5 fill-[#1d9bf0]"
            ...
            <button onClick={onAttachLocationClick}>
              <svg
                viewBox="0 0 24 24"
                aria-hidden="true"
                className="h-5 w-5 fill-[#1d9bf0]"
